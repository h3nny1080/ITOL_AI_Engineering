...
# installed.
TCL_PREFIX='O:/ITOL_AI_Engineering/Car_price_regression_model/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='O:/ITOL_AI_Engineering/Car_price_regression_model/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='O:/ITOL_AI_Engineering/Car_price_regression_model/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IO:/ITOL_AI_Engineering/Car_price_regression_model/venv\Library\include'
...
TCL_PACKAGE_PATH='O:/ITOL_AI_Engineering/Car_price_regression_model/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LO:/ITOL_AI_Engineering/Car_price_regression_model/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='O:/ITOL_AI_Engineering/Car_price_regression_model/venv\Library\lib\tclstub86.lib'
